(function(global, factory) {
  ...
  function drawSelectionRange(cm, range, output) {
    ...
    function drawForLine(line, fromArg, toArg) {
      ...
      iterateBidiSections(getOrder(lineObj, doc.direction), fromArg || 0, toArg == null ? lineLen : toArg, function(
        from,
        to,
        dir
      ) {
    ...
    for (;;) {
      ...
      if (next[1]) {
        ...
        if (i < 0 && (!tag || tag == next[2]))
          return { tag: next[2], from: Pos(startLine, startCh), to: Pos(iter.line, iter.ch) };
      } else {
        stack.push(next[2]);
      }
    }
    ...
    for (;;) {
      ...
      if (start[1]) {
        ...
        if (i < 0 && (!tag || tag == start[2]))
          return { tag: start[2], from: Pos(iter.line, iter.ch), to: Pos(endLine, endCh) };
      }
    }
  }
...
(function(mod) {
  ...
  else if (typeof define == 'function' && define.amd) define(['../../lib/codemirror', './xml-hint'], mod);
  else mod(CodeMirror);
})(function(CodeMirror) {
  'use strict';
  ...
  var s = { attrs: {} };
  var data = {
    a: { attrs: { href: null, ping: null, type: null, media: media, target: targets, hreflang: langs } },
    abbr: s,
    acronym: s,
    address: s,
    applet: s,
    ...
    samp: s,
    script: {
      attrs: { type: ['text/javascript'], src: null, async: ['', 'async'], defer: ['', 'defer'], charset: charsets },
    },
    section: s,
    select: {
      attrs: {
    ...
    strike: s,
    strong: s,
    style: { attrs: { type: ['text/css'], media: media, scoped: null } },
    sub: s,
    summary: s,
    sup: s,
    table: s,
