 ...
 */ (function(
  ...
  function e(a) {
    ...
    return d && 'BODY' !== d && 'HTML' !== d
      ? -1 !== ['TD', 'TABLE'].indexOf(c.nodeName) && 'static' === b(c, 'position')
        ? e(c)
        : c
  ...
  function n() {
    var a = window.document.body,
      ...
      c = Q() && window.getComputedStyle(b);
    return { height: m('Height', a, b, c), width: m('Width', a, b, c) };
  }
  function o(a) {
  ...
  function p(a) {
    ...
    if (k || m) {
      var p = b(a);
      (k -= l(p, 'x')), (m -= l(p, 'y')), (f.width -= k), (f.height -= m);
    }
    return o(f);
  }
  function q(a, c) {
    var e = Q(),
      ...
      i = d(a),
      j = b(c),
      l = +j.borderTopWidth.split('px')[0],
      m = +j.borderLeftWidth.split('px')[0],
      n = o({ top: g.top - h.top - l, left: g.left - h.left - m, width: g.width, height: g.height });
    if (((n.marginTop = 0), (n.marginLeft = 0), !e && f)) {
      var q = +j.marginTop.split('px')[0],
        r = +j.marginLeft.split('px')[0];
      (n.top -= l - q),
        (n.bottom -= l - q),
        (n.left -= m - r),
        (n.right -= m - r),
    ...
    return (e ? c.contains(i) : c === i && 'BODY' !== i.nodeName) && (n = k(n, c)), n;
  }
  function r(a) {
    var b = window.document.documentElement,
      c = q(a, b),
      d = O(b.clientWidth, window.innerWidth || 0),
      e = O(b.clientHeight, window.innerHeight || 0),
      f = j(b),
      g = j(b, 'left'),
      h = { top: f - c.top + c.marginTop, left: g - c.left + c.marginLeft, width: d, height: e };
    return o(h);
  }
  function s(a) {
    var d = a.nodeName;
    return 'BODY' === d || 'HTML' === d ? !1 : !('fixed' !== b(a, 'position')) || s(c(a));
  }
  function t(a, b, e, f) {
    var g = { top: 0, left: 0 },
      i = h(a, b);
    if ('viewport' === f) g = r(i);
      ...
      var j;
      'scrollParent' === f
        ? ((j = d(c(a))), 'BODY' === j.nodeName && (j = window.document.documentElement))
        : 'window' === f
        ? (j = window.document.documentElement)
        : (j = f);
      var k = q(j, i);
      if ('HTML' === j.nodeName && !s(i)) {
        var l = n(),
          m = l.height,
          o = l.width;
  ...
  function J(a, b, c) {
    var d = void 0 === c ? a : a.slice(0, x(a, 'name', c));
    return (
      d.forEach(function(a) {
        ...
        a.enabled &&
          E(c) &&
          ((b.offsets.popper = o(b.offsets.popper)), (b.offsets.reference = o(b.offsets.reference)), (b = c(b, a)));
      }),
      b
    );
  }
  ...
  function L(a, b) {
    Object.keys(b).forEach(function(c) {
      var d = '';
      -1 !== ['width', 'height', 'top', 'right', 'bottom', 'left'].indexOf(c) && H(b[c]) && (d = 'px'),
        (a.style[c] = b[c] + d);
    });
  }
  function M(a, b, c, e) {
    var f = 'BODY' === a.nodeName,
      g = f ? window : a;
    g.addEventListener(b, c, { passive: !0 }), f || M(d(g.parentNode), b, c, e), e.push(g);
  }
  function N(a, b, c, e) {
    (c.updateBound = e), window.addEventListener('resize', c.updateBound, { passive: !0 });
    var f = d(a);
    return M(f, 'scroll', c.updateBound, c.scrollParents), (c.scrollElement = f), (c.eventsEnabled = !0), c;
  }
  for (
    var O = Math.max,
      P = void 0,
      ...
      S = ['native code', '[object MutationObserverConstructor]'],
      T = function(a) {
  ...
  var i = U && T(window.MutationObserver),
    Y = i
      ? function(a) {
          var b = !1,
            c = 0,
  ...
  (a.computeAutoPlacement = v),
    (a.debounce = Y),
    (a.findIndex = x),
    (a.getBordersSize = l),
    (a.getBoundaries = t),
    (a.getBoundingClientRect = p),
    (a.getClientRect = o),
    (a.getOffsetParent = e),
    (a.getOffsetRect = y),
    (a.getOffsetRectRelativeToArbitraryNode = q),
    (a.getOuterSizes = z),
    (a.getParentNode = c),
    (a.getPopperOffsets = B),
    (a.getReferenceOffsets = C),
    (a.getScroll = j),
    (a.getScrollParent = d),
    (a.getStyleComputedProperty = b),
    (a.getSupportedPropertyName = D),
    (a.getWindowSizes = n),
    (a.isFixed = s),
    (a.isFunction = E),
    (a.isModifierEnabled = F),
    (a.isModifierRequired = G),
    (a.isNative = T),
    (a.isNumeric = H),
    (a.removeEventListeners = I),
    (a.runModifiers = J),
    (a.setAttributes = K),
    (a.setStyles = L),
    (a.setupEventListeners = N),
    (a['default'] = {
      ...
      getOffsetParent: e,
      getOffsetRect: y,
      getOffsetRectRelativeToArbitraryNode: q,
      getOuterSizes: z,
      getParentNode: c,
      getPopperOffsets: B,
      ...
      getSupportedPropertyName: D,
      getWindowSizes: n,
      isFixed: s,
      isFunction: E,
      isModifierEnabled: F,
      isModifierRequired: G,
      isNative: T,
      isNumeric: H,
