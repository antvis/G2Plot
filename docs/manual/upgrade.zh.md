...
| GroupedBar           | 改用 Bar 实现。<br/>删除 groupField 配置，改为 seriesField，需要指定 `isGroup: true`。                                                                                                                     | [Bar](../../examples/bar/grouped)                     |
| RangeBar             | 改用 Bar 实现。 <br/>需要指定 `isRange: true`。 <br/> label 不再支持 topStyle、bottomStyle，详细配置请参考 [API](../../examples/bar/range/API#label) 文档                                                     | [Bar](../../examples/bar/range)                     |
...
| PercentStackedArea   | 改用 Area 实现。去掉 stackField ，改用 seriesField ，需要指定 `isStack: true`、`isPercent: true`。                                                                                                                            | -                                                     |
...
| trendLine   | 不再支持，改用 regressionLine 实现，改写方式 todo @福晋 | -                                                                                                              |
...
| WordCloud                       | maskImage: 不再支持， 改用 imageMask。<br /> wordStyle 选项中的 gridSize 改为 padding。<br /> 现在必须设置 wordField 和 weightField                                                                                | -                                                                                                              |
