...
功能描述： 多色面积图必选。 数据集中的分组字段名，一般对应一个分类字段。通过该字段的值，数据将会被分为多个组，通过颜色进行区分，视觉上呈现为多个 area 形状。
...
| showCrosshairs | boolean | 是否显示 tooltip 辅助线                                                                                                                                                                                                                                                                                                                                                        |
...
| fields         | string  | 设置 tooltip 内容字段，默认为[ `xField`, `yField`]                                                                                                                                                                                                                                                                                                                             |
