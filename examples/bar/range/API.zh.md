...
功能描述： 标签文本，与其他条形图家族图表不同，区间条形图的 label 为一对。

[DEMO](../../bar/range#range-bar-label)
...
| -------------- | -------- | ----------------------------------------------------------------------------------------------------- |
| visible        | boolean  | 是否显示                                                                                              |
| position       | string   | label 的位置<br />- outter  位于柱子外侧，即左侧和右侧<br />- inner  位于柱子内侧，即左部和右部<br /> |
| formatter      | function | 对文本标签内容进行格式化                                                                              |
| style          | object   | 配置 label 的样式                                                                                     |
| leftStyle      | object   | 配置左侧 label 样式<br />如果同时配置了 style 和 leftStyle，左侧 label 的样式将以 leftStyle 为准。    |
| rightStyle     | object   | 配置右侧 label 样式<br />如果同时配置了 style 和 rightStyle，右侧 label 样式将以 rightStyle 为准。    |
