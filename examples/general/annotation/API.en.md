...
G2Plot 继承了 G2 的图形标注配置，[详细介绍](http://localhost:8000/en/docs/manual/tutorial/annotation)
...
使用示例: *绘制中位线*, [Demo](../line-annotation)
...
使用示例: [Demo](../../../column/basic#region-annotation)
