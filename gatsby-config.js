...
module.exports = {
  ...
  siteMetadata: {
    ...
    announcement: {
      zh: '1. 上新图表啦！请前往「教程 - 图表指引」查看「分面图、小提琴图」介绍。2. 「旭日图」支持下钻啦！3. 期待已久的国际化也来了。4. 更多内容，请前往 G2Plot 可视化圈子：https://www.yuque.com/antv/g2plot/v2.3.22 🔎 查看',
      en: '1. 上新图表啦！请前往「教程 - 图表指引」查看「分面图、小提琴图」介绍。2. 「旭日图」支持下钻啦！3. 期待已久的国际化也来了。4. 更多内容，请前往 G2Plot 可视化圈子：https://www.yuque.com/antv/g2plot/v2.3.22 🔎 查看',
    }
  },
};
