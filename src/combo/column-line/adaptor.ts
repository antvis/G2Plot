 ...
 * @param params
 */
export function getOptions(params: Params<ColumnLineOption>): Params<ColumnLineOption> {
  const mixOption = {
    options: {
      lineConfigs: [
        deepMix(
 ...
 * @param params
 */
function field(params: Params<ColumnLineOption>): Params<ColumnLineOption> {
 ...
 * @param options
 */
export function adaptor(params: Params<ColumnLineOption>) {
