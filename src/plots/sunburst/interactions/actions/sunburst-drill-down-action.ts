...
export class SunburstDrillDownAction extends Action {
  // 存储历史下钻数据
  ...
  public resetPosition() {
    ...
    const matrix = Util.transform(null, [['t', 0, 20]]);
  ...
  public click() {
    ...
    if (!get(data, 'data.children')) return false;
    this.drill(data);
    this.drawBreadCrumb();
  }
